 ...
 * 
 */
package com.xs.rongly.framework.stater.security.spring.security.browser.controller;

import com.xs.rongly.framework.stater.core.base.BaseResult;
import com.xs.rongly.framework.stater.core.base.ResultCode;
...
import com.xs.rongly.framework.stater.security.spring.security.core.social.SocialController;
import com.xs.rongly.framework.stater.security.spring.security.core.social.support.SocialUserInfo;
...
public class BrowserSecurityController extends SocialController {
	...
	public BaseResult requireAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		return  BaseResult.fail(ResultCode.SECURITY_ACCESS_DENIED.getCode(),ResultCode.SECURITY_ACCESS_DENIED.getMsg());
	}
